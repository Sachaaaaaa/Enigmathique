...
Pour afficher une enigme, il faut ajouter le code suivant avec un onClick qui change l'état de la variable clicked
et un onPointerOver et onPointerOut qui change l'état de la variable hovered
    ...
    >
      ...
      {clicked && (
        ...
        <div style={{position: "absolute", 
              ...
              <h1>Page d`une enigme ouverte!</h1>
              <p>Contenu d`une enigme sur un chapitre</p>
            </div>
          </Html>
        )}
				</mesh>
...
useGLTF.preload("/Demo_Room-002.glb");
