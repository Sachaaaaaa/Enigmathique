...
const ComputerConsoleEnigma = (closePopup) => {
	...
	const handleExecuteCommand = () => {
		...
		case 'ipconfig':
			...
			break;
		case 'info':
			setOutputResponse('Documentation du Reacteur :\nPrototype du réacteur à énergie atomique A23, produit de l\'énergie a partir d\'atome placer a l\'intérieur. Le réacteur a un diamétre de 80 dm, une cage en titane et une turbine. Le réacteur est relié au réseau électrique, tous les câbles de la salle de test peuvent supporter une tension de 230V et ont une résistance de 14.375 Ohm. \nProcessus de démarrage du réacteur : \n1) Le reacteur a besoin d\'un atome spécifique pour fonctionner. \n2) Pour le bon fonctionnement du reacteur, il faut le refroidir avec un fuide caloporteur comme H2O. Remplir le réacteur avec la formule indiqué. \n3) Ce meme fluide caloporteur doit être a la température indiqué : [30;43]∩[43;68] \n4) Avant de lancé le réacteur, il faut configurer l\'intensité du courant');
			break;
		case 'formule':
