...
const ClassElem = (props) => {
    ...
    return (
        <article className="bg-white m-5 border-2 rounded-[30px] shadow-md w-full md:max-w-md xl:max-w-lg flex flex-col min-h-[700px]">
            <div className="p-5">
            ...
            <div className="px-5 mt-auto">
                <p className="text-lg font-semibold mb-4">Taux de réussite moyen : {props.classGroup.winRate}%</p>
            </div>
